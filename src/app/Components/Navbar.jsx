...
<nav className="border-gray-200 bg-blue-950 dark:bg-blue-950 dark:border-gray-700">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 pl-16 pr-9">
    <Link href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
        <Image src="robot" className="h-8" alt="Robot" />
    </Link>
    ...
    <div className="font-lexend hidden w-full md:block md:w-auto" id="navbar-solid-bg">
      <ul className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
        ...
        <li>
          <Link href="#" className="block py-2 px-3 md:px-3 text-white rounded bg-yellow-400 hover:bg-blue-200 md:hover:bg-blue-300 md:border-0 md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contactanos</Link>
        </li>
      </ul>
    </div>
  </div>
