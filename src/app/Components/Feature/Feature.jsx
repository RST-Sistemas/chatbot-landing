  ...
  return (
    <div className='flex flex-col items-center h-full gap-5 pt-10 bg-base-100 '>
      ...
      {/* <div className='flex flex-col items-center'>
        <Link
          href='#contact'
          className='text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900 my-1'
        >
          <Button />
        </Link>
      </div> */}
