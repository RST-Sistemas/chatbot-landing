...
export default function CostumePackage() {
  return (
    <>
      <div className='flex-col justify-between hidden w-full p-6 text-center bg-white border border-gray-100 rounded-lg shadow hover:scale-105 hover:shadow-xl hover:transition-all hover:duration-300 min-[1280px]:hidden min-[1439px]:flex min-[1167px]:flex text-neutral'>
            ...
            <div className='flex flex-col md:flex-col-reverse md:items-start'>
              ...
              <div className='flex flex-col w-full md:flex-row md:justify-between'>
                ...
                <div className='flex-col items-center hidden gap-3 md:flex md:flex-row'>
                  <p className='mb-2 text-base font-bold md:mb-0 '>
                    A PARTIR DE
                  </p>
      ...
      <div className=' flex min-[1439px]:hidden min-[1167px]:hidden min-[1280px]:flex hover:scale-105 hover:shadow-xl hover:transition-all hover:duration-300  min-h-[846px] w-full md:w-[349px] flex-col justify-between lg p-6 text-center bg-white border border-gray-100 rounded-lg shadow text-neutral '>
        <div>
